...
// import convertRange from 'koalition-utils/'koalition-utils/math/convert-range';';
 ...
 * Colors
 */
const colorPurple = Color('#b289ad'),
...
const createSpotGradient = (x, y, radius, color) => {
  ...
  const gradient = context.createRadialGradient(
    ...
    x + 0.001,
    y,
    radius > 20 ? radius * 0.8 : radius * 0.25
  );
...
const createGradient = (x, y, radius, color, isHalo) =>
  isHalo
    ? createHaloGradient(x, y, radius, color)
    : createSpotGradient(x, y, radius, color);
